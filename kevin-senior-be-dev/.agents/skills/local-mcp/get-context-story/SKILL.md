...
## Description
Kỹ năng này chịu trách nhiệm truy xuất toàn bộ dữ liệu nghiệp vụ và ngữ cảnh của một User Story từ kho lưu trữ thông tin dự án, làm cơ sở để phân rã nhiệm vụ và thiết kế giải pháp kỹ thuật Backend.
